...
describe("MemoryOpsPolicyPanel", () => {
  it("renders the auto patrol policy switch", () => {
    ...
    expect(html).toContain("Enable local maintenance daemon while the app is running")
    expect(html).toContain("Daemon check interval")
    expect(html).toContain("Lightweight due check only; not a full patrol interval")
