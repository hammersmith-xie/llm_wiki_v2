    ...
    async function init() {
      try {
        await hydrateStartupSettings({
          ...
          store: useWikiStore.getState(),
          resolveActivePreset: async (activePresetId, providerConfigs, fallback) => {
            ...
            return resolveConfig(preset, providerConfigs?.[activePresetId], fallback)
          },
